    ...
    <div className="rom-form">
      ...
      {attending === 'yes' && (
        <>
          ...
          <div className="rom-field">
            <label className="rom-label">Do you have any food allergies?</label>
            <div className="rom-toggle-row">
              <button className={`rom-toggle-btn${allergies === 'yes' ? ' active' : ''}`} onClick={() => setAllergies('yes')}>Yes</button>
              <button className={`rom-toggle-btn${allergies === 'no' ? ' active' : ''}`} onClick={() => setAllergies('no')}>No</button>
            </div>
            {allergies === 'yes' && (
              <input
                className="rom-number-input"
      ...
      <div className="rom-rsvp" id="rsvp">
        <div className="rom-wrap">
          {isDraft ? (
            ...
            <div className="rom-form" style={{ textAlign: 'center', padding: '3rem 2rem' }}>
              <h3 style={{ fontFamily: 'Playfair Display, serif', fontStyle: 'italic', fontSize: '1.6rem', color: '#b85670', marginBottom: '.75rem' }}>
                Live RSVP Preview
              </h3>
              <p style={{ fontSize: '.86rem', color: '#9b7080', lineHeight: '1.6' }}>
