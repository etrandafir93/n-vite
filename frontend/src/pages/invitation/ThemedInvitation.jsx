...
const css = `
  .ti-page{min-height:100vh;background:var(--ti-bg);color:var(--ti-text);font-family:'Inter',system-ui,sans-serif}.ti-page *{box-sizing:border-box}.ti-wrap{width:min(1080px,calc(100vw - 1rem));margin:0 auto}.ti-page img{max-width:100%;display:block}
  ...
  @media (max-width:700px){.ti-wrap{width:min(100vw - .75rem,1080px)}.ti-dress{grid-template-columns:1fr}.ti-schedule__item{grid-template-columns:1fr;gap:.25rem}.ti-countdown{gap:.7rem}.ti-countdown__unit{min-width:66px;padding:.72rem .55rem}.ti-countdown__num{font-size:1.55rem}}
`
